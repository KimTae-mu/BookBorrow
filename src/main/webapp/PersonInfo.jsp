...
<table class="table ">
    <tr>
        ...
        <td width="33%" align="center">
            <a href=""><font size="4px" color="white">个人信息</font></a>
        </td>
...
<div align="center"><font size="4" color="#1e90ff"><c:out value="${status}"/></font> </div>
<form action="InsertPerson">
    <div class="list-group">
        <div class="input-group input-group-lg">
            <div class="input-group-addon">姓名</div>
            <input type="text" name="username" class="form-control" placeholder="请输入真实姓名">
        </div>
    ...
    <div class="list-group">
        <div class="input-group input-group-lg">
            ...
            <input type="text" name="address" class="form-control" placeholder="输入家庭地址">
        </div>

        <div class="input-group input-group-lg">
            <div class="input-group-addon">邮箱</div>
            <input type="text" name="mail" class="form-control" placeholder="正确书写邮箱">
        </div>
    </div>
    <button class="list-group-item  active  " style="text-align:center;">
        <font color="white">确认</font>
    </button>
</form>

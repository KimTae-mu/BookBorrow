            ...
            <c:forEach items="${sort}" var="sort">
                <div class="col-xs-6 col-md-3 col-sm-4">
                    <div align="center" class="thumbnail">
                        <a href="gain.action?isbn=${sort.isbn}&sort=${sort.sort}">
                            <img src="${sort.address}" alt="">
                            <div class="caption" style=" white-space:nowrap;overflow:hidden;
